...
The result is three columns (a fixed 200px sidebar, a flexible middle column
where `1fr` means “use up the available space”, and another 200px sidebar),
three rows (a header, main content, and footer), with a 20px gap between every
cell.
