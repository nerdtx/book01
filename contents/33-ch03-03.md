...
Every HTML page begins with a specific structure. It tells the browser what
version of HTML you’re using and where the content starts and ends.

Here’s how to build that foundation. Once this structure is in place, you can add content, style it, and
