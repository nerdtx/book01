...
An **instruction** is a single operation a computer knows how to perform. Each
...
or video games) are nothing more than billions of these small instructions
working together in sequence.  Want to change the color of
